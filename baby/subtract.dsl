...
<html doctype>
	<head viewport title="BabyCOBOL: SUBTRACT">
	<body>
		<header/>
...
<!-- [('size', '34:'), ('begin',), ('skip',), ('term', 'SUBTRACT', 4), ('skip', 2), ('nt', 'Atomic', 3), ('skip',), ('uploop', 5), ('skip',), ('term', 'FROM', 2), ('skip',), ('nt', 'Atomic', 3), ('skip',), ('save', '1'), ('skip', 12), ('end',), ('load', '1'), ('downbranch',), ('term', 'GIVING', 3), ('skip',), ('nt', 'Identifier', 5), ('backbranch',)] -->
