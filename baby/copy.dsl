...
<html doctype>
	<head viewport title="BabyCobol: COPY" css="babycobol.css">
	<body>
		<header/>
...
<h2>Origins</h2>
<span class="ff lang"><a href="appbuilder.html">AppBuilder</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="appbuilder.html" title="call a rule or a component from into another rule">USE</a></span> <br/><span class="ff lang"><a href="cobol.html">COBOL</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="cobol.html" title="a directive to include another file">COPY</a></span> <span class="ff used"><a href="cobol.html" title="a directive to switch ongoing replacements on or off">REPLACE</a></span> <br/><span class="ff lang"><a href="pli.html">PL/I</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="pli.html" title="incorporate external text into the source program">%INCLUDE</a></span> <br/>
		<hr/>
		<div class="last">
