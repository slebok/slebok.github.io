...
<!-- [('size', '47:5:0'), ('begin',), ('skip',), ('term', 'IF', 1), ('skip',), ('nt', 'BooleanExpression', 9), ('skip',), ('term', 'THEN', 2), ('skip', 2), ('nt', 'Statement', 5), ('skip',), ('uploop', 7), ('skip',), ('save', '1'), ('skip', 13), ('save', '2'), ('skip', 6), ('end',), ('load', '1'), ('downbranch', 2), ('term', 'ELSE', 2), ('skip', 2), ('nt', 'Statement', 5), ('skip',), ('uploop', 7), ('backbranch', 2), ('load', '2'), ('downbranch',), ('term', 'END', 2), ('backbranch',)] -->
...
<h2>Remarks</h2>
<ul><li>an <code>END</code>-less <code>IF</code> is terminated at the end of the sentence (by <code>.</code>) or by the start of the next statement</li><li>note that both branches of the <code>IF</code> consist of statements, not sentences, so dots inside the entire <code>IF</code> construct are not allowed</li></ul>
<h2>Origins</h2>
