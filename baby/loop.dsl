...
<html doctype>
	<head viewport title="BabyCobol: LOOP" css="babycobol.css">
	<body>
		<header/>
...
<h2>Origins</h2>
<span class="ff lang"><a href="appbuilder.html">AppBuilder</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="appbuilder.html" title="a multi-purpose loop statement with a number of detachable clauses">DO</a></span> <br/><span class="ff lang"><a href="clist.html">CLIST</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="clist.html" title="execute a sequence of commands repeatedly">DO</a></span> <br/><span class="ff lang"><a href="cobol.html">COBOL</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="cobol.html" title="execute a list of statements repeatedly">PERFORM (in-line)</a></span> <br/><span class="ff lang"><a href="fortran.html">FORTRAN</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="fortran.html" title="execute a statement repeatedly">DO</a></span> <br/><span class="ff lang"><a href="pli.html">PL/I</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="pli.html" title="repeat a group of statements under certain conditions">DO</a></span> <br/><span class="ff lang"><a href="rexx.html">REXX</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="rexx.html" title="execute a group of instructions repeatedly">DO</a></span> <br/><span class="ff lang"><a href="rpg.html">RPG</a></span>&nbsp;&nbsp;&nbsp;<span class="ff used"><a href="rpg.html" title="execute a group of operations several times">DO</a></span> <span class="ff used"><a href="rpg.html" title="execute a group of operations until a condition is met">DOU</a></span> <span class="ff used"><a href="rpg.html" title="execute a group of operations while a condition holds">DOW</a></span> <span class="ff used"><a href="rpg.html" title="iterate over a group of operations">FOR</a></span> <br/>
		<hr/>
		<div class="last">
