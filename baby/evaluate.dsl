...
<svg xmlns="http://www.w3.org/2000/svg" width="880px" height="120px">
	<defs>
		<style type="text/css">
...
<!-- [('size', '44:6:1'), ('begin',), ('skip',), ('term', 'EVALUATE', 4), ('skip',), ('nt', 'AnyExpression', 7), ('skip', 2), ('save', '1'), ('skip', 21), ('uploop', 22), ('skip',), ('term', 'END', 2), ('skip',), ('end',), ('load', '1'), ('downbranch', 2), ('term', 'WHEN', 2), ('skip',), ('save', '2'), ('skip', 2), ('nt', 'Atomic', 3), ('skip',), ('uploop', 5), ('skip', 3), ('nt', 'Statement', 5), ('skip',), ('uploop', 7), ('backbranch', 2), ('load', '2'), ('downbranch',), ('skip',), ('term', 'OTHER', 3), ('skip',), ('backbranch',)] -->
<polygon points="28 40 20 36 20 44"/><polygon points="36 40 28 36 28 44"/><path d="M 36 40 h 20"/><text x="56" y="44">EVALUATE</text><path d="M 136 40 h 20"/><text class="i" x="156" y="44">&nbsp;AnyExpression</text><path d="M 296 40 h 40"/><path d="M 336 40 h 420"/><path d="M 756 40 v -20 h -440 v 20"/><polygon points="316 39 312 31 320 31"/><path d="M 756 40 h 20"/><text x="776" y="44">&nbsp;END</text><path d="M 816 40 h 20"/><polygon points="844 40 836 36 836 44"/><polygon points="844 40 852 36 852 44"/><path d="M 336 40 v 40 h 20"/><text x="356" y="84">WHEN</text><path d="M 396 80 h 20"/><path d="M 416 80 h 40"/><text class="i" x="456" y="84">Atomic</text><path d="M 516 80 h 20"/><path d="M 536 80 v -20 h -100 v 20"/><polygon points="436 79 432 71 440 71"/><path d="M 536 80 h 60"/><text class="i" x="596" y="84">&nbsp;Statement</text><path d="M 696 80 h 20"/><path d="M 716 80 v -20 h -140 v 20"/><polygon points="576 79 572 71 580 71"/><path d="M 716 80 h 20 v -40"/><polygon points="736 41 732 49 740 49"/><path d="M 416 80 v 20 h 20"/><path d="M 436 100 h 20"/><text x="456" y="104">&nbsp;OTHER</text><path d="M 516 100 h 20"/><path d="M 536 100 h 20 v -20"/><polygon points="556 81 552 89 560 89"/>
</svg>
