...
<html doctype>
	...
	<body>
		...
		<hr/>
			<h2>Soulmates <span class="edit"><a href="https://github.com/slebok/grass/edit/master/Structure/Dependency/Soulmates.tax">Edit!</a></span></h2>
			<p>Related smells: <a href="http://tusharma.in/smells/CROSSM.html">Implicit Cross-Module Dependency</a>, <a href="http://tusharma.in/smells/PIH.html">Parallel Inheritance Hierarchies</a>, <a href="http://tusharma.in/smells/SS.html">Shotgun Surgery</a>, <a href="http://tusharma.in/smells/SSS.html">Shotgun Surgery</a>, <a href="http://tusharma.in/smells/FE.html">Feature Envy</a>, <a href="http://tusharma.in/smells/SFE.html">Feature Envy</a>, <a href="http://tusharma.in/smells/II.html">Inappropriate Intimacy</a>, <a href="http://tusharma.in/smells/SII.html">Inappropriate Intimacy</a><br/></p><p> If enough information is available about the evolution of the grammar (e.g., in a form of a versioned repository or a piece of documentation describing all changes), one can notice two nonterminals having a so-called <em>co-change relationship</em> when each revision that changes one, also changes the other. The smell occurs when this co-change relationship in the revision log does not correspond to explicit dependencies between modules and nonterminals. </p><p> In the absence of change history, a thought experiment may serve the same purpose: if a nonterminal <code>X</code> is to change in a particular way, what other nonterminals will have to be inevitably co-updated to preserve the consistency of the grammar? All of those, if any, are its <a href="soulmates.html">Soulmates</a>. It deserves mentioning that the programming counterpart of this smell, called “Feature Envy”, is often detectable automatically through static code analysis. The Soulmates smell, however, is only detectable with revision mining or conceptual analysis. </p><p></p>
		<hr/>
		<div class="last">
