...
<html doctype>
	...
	<body>
		...
		<pic wide>
			<name>Rivalry</name>
			<small>Related smells: <a href="http://tusharma.in/smells/AS.html">Autogenerated Stovepipe</a>, <a href="http://tusharma.in/smells/ACDI.html">Alternative Classes with Different Interfaces</a>, <a href="http://tusharma.in/smells/ERC.html">Repeated Conditionals</a><br/>TODO: siblings overlap, creating an ambiguity; AS because it can be a result of parallelisation (???) and ACDI because it can parse the same thing differently</small>
		</pic>
		<hr/>
		<div class="last">
