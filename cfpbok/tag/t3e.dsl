<html doctype>
	<head title="CfPBoK topic T3E" />
	<body>
		<credit project="CfPBoK@https://slebok.github.io/cfpbok/"/>
		<h1>Topic <code>T3E</code>: Ontologies</h1>
		Work using knowledge graphs, ontologies, or semantic web representations for language engineering tasks: semantic integration, conceptual alignment, data inference, or reasoning over language artefacts with ontology-based formalisms. If the core contribution is requirements capture, <a href="t5a.html">T5A</a> Requirements can be primary.
<clear/>
		<figure class="small">
...
<clear/>
		...
		<h2>Summary</h2>
		<ul>
			<li>Requested in <span class="info">13</span>/<span class="info">26</span> calls</li>
			<li>Requested in <span class="info">8</span>/<span class="info">19</span> pure calls (<a href="../sle2008/index.html#cfp">2008</a>–<a href="../sle2015/index.html#cfp">2015</a> with the longest streak of <span class="info">8</span> years)</li>

			<li>Primary tagged in <span class="info">6</span>/<span class="info">26</span> paper bundles</li>
			<li>Primary tagged in <span class="info">5</span>/<span class="info">19</span> pure proceedings (<a href="../sle2009/index.html#lop">2009</a>–<a href="../sle2013/index.html#lop">2013</a> with the longest streak of <span class="info">5</span> years)</li>

			<li>Secondary tagged in <span class="info">4</span>/<span class="info">26</span> paper bundles</li>
			<li>Secondary tagged in <span class="info">3</span>/<span class="info">19</span> pure proceedings (<a href="../sle2010/index.html#lop">2010</a>–<a href="../sle2017/index.html#lop">2017</a> with the longest streak of <span class="info">2</span> years)</li>
			<li>Top 3 co-occurring topics:
				<ul>
					...
					<li><a href="t3c.html"><span class="tagL">T3C: DSLs</span></a> (<span class="info">2</span> times)</li>
					<li><a href="t1d.html"><span class="tagL">T1D: Composition</span></a> (<span class="info">2</span> times)</li>
				</ul>
<li>Top 3 contributors:
				<ul>
					<li><a href="../profile/GiancarloGuizzardi.html">Giancarlo Guizzardi</a> (<span class="info">2</span> times)</li>
					<li><a href="../profile/VeruskaZamborlini.html">Veruska Zamborlini</a> (<span class="info">2</span> times)</li>
					<li><a href="../profile/YonggangZhang.html">Yonggang Zhang</a> (<span class="info">1</span> times)</li>
				</ul>

		</ul>

<h2>List of papers (11)</h2>
<ul>
...
">T5E</span></a></li><li><span class="info">(<a href="../sle2009/index.html">SLE 2009</a>)</span> <em><a href="../sle2009/paper12.html">Ontological Metamodeling with Explicit Instantiation</a></em> (<a href="../profile/AlfonsLaarman.html">Alfons Laarman</a>, <a href="../profile/IvanKurtev.html">Ivan Kurtev</a>) 
...
">T5D</span></a></li><li><span class="info">(<a href="../sle2010/index.html">SLE 2010</a>)</span> <em><a href="../sle2010/paper05.html">Domain-Specific Modelling Languages with Algebraic Graph Transformations on RDF</a></em> (<a href="../profile/BenjaminBraatz.html">Benjamin Braatz</a>, <a href="../profile/ChristophBrandt.html">Christoph Brandt</a>) 
...
">T3E</span></a></li><li><span class="info">(<a href="../sle2010/index.html">SLE 2010</a>)</span> <em><a href="../sle2010/keynote2.html">Software Engineering and the Semantic Web: A Match Made in Heaven or in Hell?</a></em> (<a href="../profile/AbrahamBernstein.html">Abraham Bernstein</a>) 
...
">T6B</span></a></li><li><span class="info">(<a href="../sle2011/index.html">SLE 2011</a>)</span> <em><a href="../sle2011/paper18.html">Metacompiling OWL Ontologies</a></em> (<a href="../profile/AndersNilsson.html">Anders Nilsson</a>, <a href="../profile/GörelHedin.html">Görel Hedin</a>) 
...
">T3B</span></a></li><li><span class="info">(<a href="../sle2012/index.html">SLE 2012</a>)</span> <em><a href="../sle2012/keynote2.html">Addressing Cognitive and Social Challenges in Designing and Using Ontologies in the Biomedical Domain</a></em> (<a href="../profile/MargaretAnneStorey.html">Margaret-Anne Storey</a>) 
...
">T6G</span></a></li><li><span class="info">(<a href="../sle2012/index.html">SLE 2012</a>)</span> <em><a href="../sle2012/paper16.html">A Common Foundational Theory for Bridging Two Levels in Ontology-Driven Conceptual Modeling</a></em> (<a href="../profile/GiancarloGuizzardi.html">Giancarlo Guizzardi</a>, <a href="../profile/VeruskaZamborlini.html">Veruska Zamborlini</a>) 
