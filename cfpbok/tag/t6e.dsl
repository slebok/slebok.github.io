<html doctype>
	<head title="CfPBoK tag T6E" />
	<body>
		<credit project="CfPBoK@https://slebok.github.io/cfpbok/"/>
		<h1>Tag <code>T6E</code>: Quantum</h1>
		Work about quantum software language engineering: quantum programming languages, modelling quantum processes, quantum DSLs, and language tooling specific to quantum computing contexts.
<clear/>
...
<clear/>
		...
		<ul>
			...
			<li>Requested in <span class="info">5</span>/<span class="info">19</span> pure calls</li>
			...
			<li>Secondary tagged in <span class="info">0</span>/<span class="info">26</span> paper bundles</li>
			<li>Secondary tagged in <span class="info">0</span>/<span class="info">19</span> pure proceedings</li>
