<html doctype>
	<head title="CfPBoK topic T6F" />
	<body>
		<credit project="CfPBoK@https://slebok.github.io/cfpbok/"/>
		<h1>Topic <code>T6F</code>: CPS/IoT/DT</h1>
		Work about engineering software languages for physical systems and their digital counterparts: cyber-physical systems, internet of things, digital twins, robotics, any embedded contexts where modelling and execution interacts with the physical world.
<clear/>
...
<clear/>
		...
		<h2>Summary</h2>
		<ul>
			<li>Requested in <span class="info">5</span>/<span class="info">26</span> calls</li>
			<li>Requested in <span class="info">5</span>/<span class="info">19</span> pure calls (<a href="../sle2022/index.html#cfp">2022</a>–<a href="../sle2026/index.html#cfp">2026</a> with the longest streak of <span class="info">5</span> years)</li>
			...
			<li>Secondary tagged in <span class="info">4</span>/<span class="info">19</span> pure proceedings (<a href="../sle2015/index.html#lop">2015</a>–<a href="../sle2024/index.html#lop">2024</a> with the longest streak of <span class="info">2</span> years)</li>
			<li>Top 3 co-occurring topics:
				<ul>
					<li><a href="t1b.html"><span class="tagL">T1B: Static Semantics</span></a> (<span class="info">2</span> times)</li>
					<li><a href="t1a.html"><span class="tagL">T1A: Design</span></a> (<span class="info">2</span> times)</li>
					<li><a href="t1c.html"><span class="tagL">T1C: Behavioural Semantics</span></a> (<span class="info">2</span> times)</li>
				</ul>
<li>Top 3 contributors:
				<ul>
					<li><a href="../profile/BenoîtCombemale.html">Benoît Combemale</a> (<span class="info">2</span> times)</li>
					<li><a href="../profile/TanjaMayerhofer.html">Tanja Mayerhofer</a> (<span class="info">1</span> times)</li>
					<li><a href="../profile/ManuelWimmer.html">Manuel Wimmer</a> (<span class="info">1</span> times)</li>
				</ul>
...
">T6F</span></a></li><li><span class="info">(<a href="../sle2023/index.html">SLE 2023</a>)</span> <em><a href="../sle2023/paper14.html">Enabling Blended Modelling of Timing and Variability in EAST-ADL</a></em> (<a href="../profile/MuhammadWaseemAnwar.html">Muhammad Waseem Anwar</a>, <a href="../profile/FedericoCiccozzi.html">Federico Ciccozzi</a>, <a href="../profile/AlessioBucaioni.html">Alessio Bucaioni</a>) 
