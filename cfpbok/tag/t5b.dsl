<html doctype>
	<head title="CfPBoK tag T5B" />
	<body>
		<credit project="CfPBoK@https://slebok.github.io/cfpbok/"/>
		<h1>Tag <code>T5B</code>: Language Description Analysis</h1>
...
<clear/>
		...
		<ul>
			...
			<li>Requested in <span class="info">9</span>/<span class="info">19</span> pure calls</li>
			...
			<li>Top 3 co-occurring tags:
				<ul>
					<li><a href="t4a.html"><span class="tagL">T4A: Workbenches</span></a> (<span class="info">36</span> times)</li>
					<li><a href="t3a.html"><span class="tagL">T3A: Meta-languages</span></a> (<span class="info">34</span> times)</li>
					<li><a href="t5e.html"><span class="tagL">T5E: Empirical Evaluation</span></a> (<span class="info">29</span> times)</li>
				</ul>
