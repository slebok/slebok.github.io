...
<html doctype>
	...
	<body>
		...
		<pic card>
			...
			<text>The basic alphabet is often taken for granted, especially for textual languages, but it can be an important design aspect. In some languages (APL being the extreme) the alphabet is extremely broad, with all kinds of specific symbols being used for <a href="#Standard_Library">built-in</a> operators, which shifts the visual feel of the language closer to mathematics. In other languages <a href="#Keywords">keywords</a> are taken from the English dictionary, which also in some sense limited language appeal to some groups of users (and led to reimplementations with translated keywords).</text>
			<src>PT-AO:34</src>
			<src>PT-HU:1</src>
			<src>LD-ED:5</src>
		</pic>
		...
		<hr/>
		<div class="last">
			The collection of <strong>100</strong> cards created and maintained by <a href="http://grammarware.github.io/">Dr. Vadim Zaytsev</a> a.k.a. @<a href="http://grammarware.net/">grammarware</a>.<br/>
